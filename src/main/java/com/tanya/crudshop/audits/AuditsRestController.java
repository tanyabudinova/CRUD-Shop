...
public class AuditsRestController {
    ...
    public ResponseEntity<Map<String, Long>> numberOfSoldProducts(
            @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date, Boolean available) {
    ...
    public ResponseEntity<List<ProductResponseDTO>> mostPopularProducts(Integer page, Integer pageSize) {
